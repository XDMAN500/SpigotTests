 ...
 */
public class __Sidebar implements SimpleMapEntry
{

	protected final SidebarHandler handle;

	protected Map<String,Entry> entries;
	protected Map<String,String> entriez;

	protected List<String> renderOrder;
	protected String title;
	protected final String id;
	protected final Random random = new Random();


	protected __Sidebar (SidebarHandler board, String id){
		this.id = id;
		this.handle = board;
