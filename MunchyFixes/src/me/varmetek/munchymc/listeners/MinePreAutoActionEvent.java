 ...
 */
public class MinePreAutoActionEvent extends Event
{
  ...
  public MinePreAutoActionEvent (Block theBlock, Player player, Mine mine, Inventory drops){
  ...
  public MinePreAutoActionEvent (Block theBlock, Player player, Mine mine, Collection<ItemStack> drops){
