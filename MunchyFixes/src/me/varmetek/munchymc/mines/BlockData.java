...
public class BlockData
{
  ...
  public BlockData (MaterialData data, int weight, double chance){
    this.data = data;
    this.chance = chance;
    this.weight = weight;
  }

  public BlockData (int itemID, byte itemDat, double chance, int weight){
  ...
  public static Map<MaterialData,Double> toMap(List<BlockData> list){
    Map<MaterialData,Double> map = new HashMap<>();
    for(BlockData bl : list){
      bl.put(map);
    }
    return map;
  }
